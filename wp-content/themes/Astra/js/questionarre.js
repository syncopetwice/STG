...
(function() {
  this.MR = (function(Backbone, Marionette) {
    ...
    App.addInitializer(function() {
      return App.module("Questions").start();
    });
...
(function() {
  this.MR.module("Questions", function(Questions, App, Backbone, Marionette, $, _) {
    var API;
    API = {
      show: function() {
        return Questions.Show.Controller.show();
      }
    };
    return Questions.on("start", function() {
      return API.show();
    });
  });
...
(function() { this.JST || (this.JST = {}); this.JST["backbone/apps/Questions/show/templates/_item"] = function(__obj) {
    if (!__obj) __obj = {};
    ...
    (function() {
      (function() {
        var i, item, j, len, len1, option, ref, ref1;
        ...
        __out.push(__sanitize(this.counter));
      
        __out.push('</span> / <span class="total"></span>\n      </div>\n    </div>\n  </div>\n</header>\n<main>\n  <div class="questions-title">');
        ...
        for (i = 0, len = ref.length; i < len; i++) {
          ...
          for (j = 0, len1 = ref1.length; j < len1; j++) {
            ...
            __out.push(__sanitize(this.counter));
            __out.push('-');
            __out.push(__sanitize(item.question));
            __out.push('-');
            __out.push(__sanitize(option));
            __out.push('" class="radio" name="values-');
            __out.push(__sanitize(this.counter));
            __out.push('-');
            __out.push(__sanitize(item.question));
            __out.push('" value=');
        ...
        if (this.counter !== 5) {
          __out.push('\n        <button type="button" class="js-next pull-right">Next &#62;&#62;</button>\n      ');
        } else {
...
(function() { this.JST || (this.JST = {}); this.JST["backbone/apps/Questions/show/templates/list"] = function(__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
      __out = [];
    ...
    (function() {
      (function() {
        __out.push('<div id="chapters"></div>\n');
...
(function() { this.JST || (this.JST = {}); this.JST["backbone/apps/Questions/show/templates/result"] = function(__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
      __out = [];
    ...
    (function() {
      (function() {
        __out.push('<div id="result">\n  <header>\n    <h3>Your results</h3>\n  </header>\n  <main>\n    <div class="pre-header">');
      
        __out.push(__sanitize(this.resultCounter));
      
        __out.push('</div>\n    <div>');
      
        __out.push(__sanitize(this.resultTitle));
      
        __out.push('</div>\n  </main>\n  <footer>\n    <a href="/contacts/" class="js-order">Order Salesforce optimization</a>\n  </footer>\n</div>\n');
